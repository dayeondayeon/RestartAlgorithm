...
| 백준 | [13975](https://www.acmicpc.net/problem/13975) | 1715와 유사한 우선순위 큐 문제 |
| 백준 | [1781](https://www.acmicpc.net/problem/1781) | 단순 그리디로 풀면 막힌다. (1,3), (3,7), (3,9) 일때 정답은 17 따라서 우선순위큐를 2개 사용해서 결정할 것 |

## Graph
| 플랫폼 | 문제 | 대략 설명 |
| ---- |----| ------- |
| 백준 | [11724](https://www.acmicpc.net/problem/11724) | 기본적인 그래프 문제 |
| 백준 | [1260](https://www.acmicpc.net/problem/1260) | 기본적인 BFS, DFS 그리고 인접리스트 방식 그래프 |
